...
const FAQS = [
  { q: "What is Twitter (X) Marketing and why does my business need it?",           a: "Twitter (now X) Marketing is the strategic use of X's real-time conversation platform — organic tweets, threads, X Spaces, and X Ads — to build brand awareness, drive website traffic, generate leads, and position your brand at the centre of industry conversations. With over 550 million monthly active users and unmatched real-time reach, X is where breaking news, trends, and public discourse happen first. We build X strategies that make your brand the go-to voice in your niche." },
  { q: "How long does it take to see results from Twitter (X) Marketing?",          a: "Paid X Ad campaigns (Promoted Posts, X Ads) can drive traffic and conversions within hours of launch. Organic growth — building followers, increasing tweet reach, and establishing thought leadership — typically takes 3–6 months to gain meaningful momentum. X rewards consistency and timeliness, so we build publishing cadences that keep your brand visible and relevant every day." },
  { q: "What types of content do you create for Twitter (X)?",                      a: "We create everything your X presence needs: punchy single tweets, long-form threads, poll posts, video clips, image cards, X Spaces session content, Quote Tweets for brand commentary, and pinned profile tweets. Every piece of content is crafted for X's fast-scroll feed — short enough to read in seconds, compelling enough to drive clicks, saves, and replies." },
  { q: "How do X Ads work and what formats are available?",                         a: "X Ads place your content directly in front of targeted audiences based on interests, keywords, follower lookalikes, and behaviour. Key ad formats include Promoted Posts (amplify organic tweets), X Takeovers (top-of-timeline placement), Video Ads, Carousel Ads, Lead Generation Cards (capture emails within X), and Website Click campaigns. We manage full-funnel X Ads strategies from awareness to conversion." },
  { q: "Can Twitter (X) Marketing drive real sales and revenue?",                   a: "Yes. X's keyword targeting and interest targeting let us reach users actively discussing your product category — one of the highest-intent audiences on any social platform. We combine Promoted Posts, retargeting via the X Pixel, and Lead Generation Cards to drive qualified traffic, trial sign-ups, and direct enquiries. B2B brands in particular see strong results from X's professional and executive audience." },
  { q: "What is the difference between organic X and X Ads?",                       a: "Organic X builds brand presence through regular posting, thread series, community engagement, and trending topic participation — earning reach naturally over time. X Ads amplify your content to targeted audiences who haven't found you yet, driving immediate impressions and conversions. The most effective strategy combines both: organic content builds credibility and community while paid ads extend reach and drive measurable ROI." },
  { q: "How do you measure the success of Twitter (X) campaigns?",                  a: "We track impressions, engagements (likes, retweets, replies, clicks), engagement rate, link clicks, profile visits, follower growth, video views, X Pixel conversions, ad impressions, cost-per-click, cost-per-engagement, and cost-per-lead. Monthly reports translate every metric into plain business language — what improved, why, and what we're optimising next." },
  { q: "Do I need a large budget for Twitter (X) Marketing?",                       a: "No. Organic X marketing requires no ad spend — just consistent, well-crafted content and timely engagement. For X Ads, minimum budgets are low and the platform's keyword-intent targeting can deliver efficient CPCs. We start with a focused budget to prove performance by audience and format, then recommend scaling what delivers." },
  { q: "What is X Spaces and should my brand use it?",                              a: "X Spaces is X's live audio room feature — similar to a podcast but live and interactive, with listeners able to request to speak. Brands use Spaces for product launches, expert Q&A sessions, industry panel discussions, and community AMAs (Ask Me Anything). A well-run Space dramatically increases profile visibility for all participants and positions your brand as an active industry voice. We plan, promote, and moderate X Spaces as part of your X strategy." },
  { q: "Can you manage Twitter (X) alongside other social platforms?",              a: "Yes. We manage multi-channel social strategies simultaneously, ensuring X receives content tailored to its real-time format, thread culture, and character-driven voice. X requires a completely different content approach to LinkedIn, Instagram, or TikTok — and we produce platform-native content for every channel without diluting quality or consistency." },
  { q: "What industries do you serve with Twitter (X) Marketing?",                 a: "We work across technology, SaaS, financial services, media & publishing, retail, e-commerce, professional services, politics & public affairs, sports & entertainment, healthcare, and consumer brands. X excels for any brand that benefits from real-time conversation, breaking news commentary, or direct engagement with a vocal online community." },
  { q: "How do I get started with your Twitter (X) Marketing services?",            a: "Getting started is straightforward. Book a free X strategy call — we audit your current X profile and competitor landscape, identify your highest-impact content and engagement opportunities, and present a tailored X growth plan within 5 business days. No long-term contract required on discovery. You only commit once you're confident the strategy is right for your brand." },
];
...
/* ─────────────────────────────────────────────
   PAGE
───────────────────────────────────────────── */
export function TwitterMarketingPageClient() {
    ...
    <div className="font-sans antialiased overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pb-28" style={{ background: "#0B0F1A" }}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img src="/cta-meeting-analytics.png" alt="Twitter Marketing background" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="absolute rounded-full blur-3xl" style={{ width: 320, height: 320, background: "rgba(29,155,240,0.22)", top: "12%", right: "35%" }} />
        ...
        <div className="relative w-full container mx-auto px-6 md:px-12 pt-28">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-slate-400 mb-10">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-slate-300">Twitter Marketing</span>
          </nav>
          ...
          <div className="grid md:grid-cols-[55%_45%] gap-10 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-7 text-xs font-bold tracking-widest uppercase"
                style={{ background: "rgba(29,155,240,0.18)", border: "1px solid rgba(29,155,240,0.4)", color: "#BAE6FD" }}>
                <Twitter className="w-3.5 h-3.5" style={{ color: TW }} />
                #1 Twitter Marketing Agency
              </div>
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-10 max-w-xl">
                Have you ever thought about why famous influencers&apos; Twitter posts receive millions of likes,
                comments, and shares? Well, we know the cheat code: strategic{" "}
                <strong className="text-white">Twitter marketing services</strong>{" "}
            ...
            <div className="hidden md:flex justify-center items-center">
              <div className="relative" style={{ width: 260 }}>
                ...
                <div className="relative rounded-[44px] overflow-hidden shadow-2xl"
                  ...
                  <div style={{ height: 500, background: "#fafafa" }}>
                    ...
                    <div className="flex items-center justify-between px-4 pt-8 pb-2" style={{ background: "white" }}>
                      <span className="font-black text-sm text-slate-900" style={{ fontFamily: "serif" }}>Twitter</span>
                      <div className="flex gap-3 items-center">
                        <div className="w-5 h-5 rounded-full" style={{ background: "#1D9BF0" }} />
                    ...
                    <div className="flex gap-2.5 px-3 py-2 overflow-hidden" style={{ background: "white" }}>
                      {[TW, "#F97316", "#8B5CF6", "#16A34A"].map((c, i) => (
                ...
                <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 rounded-full blur-2xl opacity-40"
                  style={{ width: 200, height: 40, background: TW }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-28 pb-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 text-center leading-tight mb-14">
            What Is Twitter Marketing and<br />
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative h-[400px] select-none">
              ...
              <div className="absolute top-0 left-0 w-[55%] h-[85%] rounded-2xl overflow-hidden shadow-lg">
                <img src="/ai-seo-team.png" alt="Twitter marketing on mobile"
              ...
              <div className="absolute bottom-0 right-0 w-[54%] h-[72%] rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                <img src="/cta-meeting-analytics.png" alt="Twitter social media icons"
                  className="w-full h-full object-cover" />
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-full px-4 py-2 text-white whitespace-nowrap"
                  style={{ background: "linear-gradient(135deg, #1D9BF0, #F97316)", boxShadow: "0 4px 16px rgba(29,155,240,0.45)" }}>
                  <BarChart3 className="w-3.5 h-3.5 flex-shrink-0" />
                  <div>
                    <p className="text-xs font-extrabold leading-none">5.2× More Engagement</p>
                    <p className="text-[10px] opacity-85 leading-tight mt-0.5">Average Twitter performance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-5 left-0 flex items-center gap-2.5 bg-white rounded-xl px-4 py-3 z-10"
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 mt-0.5">Across client Twitter accounts</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4">
              <p className="text-slate-600 leading-relaxed mb-5">
                Twitter Marketing refers to the process of using the Twitter platform to create brand recognition
              ...
              <p className="text-slate-600 leading-relaxed mb-8">
                Twitter&apos;s visual appeal and wide audience make it an essential tool for marketers looking to
                tap into consumer desires and connect with potential clients. So, boost your Twitter marketing
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Twitter Features We Master to Grow Your Brand
              <br />
              <span style={{ color: ACCENT }}>and Engage Your Audience</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Top SEO Services delivers comprehensive Twitter marketing services designed to grow your audience,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                name: "Twitter Reels Marketing",
                img: "/industry-ecommerce.png",
                desc: "Reels are Twitter's highest-reach format. Our creative team produces trend-native, brand-aligned Reels that maximise organic reach and attract new followers at scale.",
              },
              {
                name: "Twitter Stories Management",
              ...
              {
                name: "Twitter Shopping & E-commerce",
                img: "/industry-shopify.png",
                desc: "We set up and optimise your Twitter Shop catalogue, tag products across Feed, Reels, and Stories, and build a seamless in-app purchase experience that shortens the path to checkout.",
              },
              {
              ...
              },
              {
                ...
                img: "/ai-seo-team.png",
                desc: "We identify, vet, and manage Twitter creator partnerships — from nano-influencers with niche, engaged audiences to macro influencers for mass brand awareness.",
              },
              {
              ...
              },
              {
                ...
                desc: "From prospecting campaigns to retargeting funnels, we manage your Twitter Ad spend with precision — building creative that converts with measurable ROI.",
              },
              {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="md:w-[46%] flex-shrink-0 relative min-h-[220px]">
              <img src="/local-cta-analytics.png" alt="Twitter growth analytics"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-12 relative z-10">
              <h2 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3">
                Ready to Build an Twitter Presence{" "}
                <span style={{ color: TW }}>That Drives Revenue?</span>
              </h2>
              <p className="text-slate-300 text-sm leading-relaxed mb-8 max-w-md">
                Our Twitter specialists craft strategies tailored to your brand, audience, and growth goals —
              ...
              <div>
                <Link href="/contact"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white text-sm"
                  style={{ background: TW }}>
                  Book a Free Twitter Audit <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              In this competitive world, Twitter marketing performance is vital for businesses looking to broaden their
              reach, engage their audience, and boost conversions. With our results-focused Twitter marketing services
          ...
          {(() => {
            const cards = [
              { num: "01", icon: Target,      color: ACCENT,    title: "Brand Awareness",       desc: "Utilize Twitter's massive reach to grow your brand's presence and recognition." },
              ...
              { num: "05", icon: Users,       color: ACCENT,    title: "Sales & Leads",         desc: "The lead development process enables businesses to convert Twitter followers into customers through direct sales opportunities." },
            ];
            return (
              <>
                {/* Row 1 — 3 cards */}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <span className="text-xs font-bold tracking-widest uppercase mb-3 block" style={{ color: TW }}>
              Industries
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Industries We Support With{" "}
              <span style={{ color: TW }}>Twitter<br />Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Twitter marketing agency delivers industry-scaled services that boost follower growth, content reach,
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { img: "/industry-healthcare.png",  icon: Heart,        iconBg: TW,        label: "Healthcare"  },
          ...
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              ...
              <p className="text-pink-100 text-sm leading-relaxed mb-7 max-w-md">
                We help brands turn Twitter followers into engaged communities and loyal
              ...
              <div>
                <Link href="/contact"
                  ...
                  Schedule Your Twitter Strategy Call <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            <div className="md:w-[36%] flex-shrink-0 relative min-h-[200px] hidden md:block">
              <img src="/ai-seo-team.png" alt="Twitter marketing expert"
                className="absolute bottom-0 right-0 h-full w-full object-cover object-top opacity-90" />
              <div className="absolute inset-0"
                style={{ background: "linear-gradient(to right, " + TW + " 0%, transparent 40%)" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              How Twitter Marketing Services Help
              <br />
              <span style={{ color: ACCENT }}>Modern Businesses to Grow</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Twitter marketing strategies combine creative storytelling, data analytics, and platform expertise to
            ...
            {[
              {
                ...
                desc: "We analyze your ideal Twitter audience — their demographics, interests, behaviors, and peak activity times — to create content strategies that resonate and drive meaningful engagement.",
              },
              {
                icon: Video,
                color: "#DC2626",
                title: "Reels & Video Strategy",
                desc: "Our video team creates scroll-stopping Twitter Reels and video content using trending formats, audio, and hooks that maximize organic reach and virality on the platform.",
              },
              {
                icon: Layers,
                color: "#D97706",
                title: "Visual Content Design",
                desc: "Our designers craft stunning feed posts, carousel slides, and story templates that maintain brand consistency while standing out in crowded Twitter feeds.",
              },
              {
                icon: BarChart3,
                color: "#16A34A",
              ...
              },
              {
                ...
                desc: "Our team actively manages your Twitter community through timely responses, comment engagement, DM management, and proactive outreach that builds loyal brand advocates.",
              },
              {
                icon: RefreshCw,
                color: "#DC2626",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <span className="inline-block text-xs font-bold px-5 py-2 rounded-full border mb-5"
              style={{ borderColor: TW, color: TW }}>
              Pricing
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Twitter Marketing Packages That Turn
              <br />Followers Into{" "}
              <span style={{ color: TW }}>Customers</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Twitter marketing packages focus on building engaged audiences, driving Reels reach,
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 flex flex-col"
              ...
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: TW }}>
              ...
              <p className="text-slate-400 text-sm mb-6">Twitter account management<br />— Feed posts, Stories & basic Reels</p>
              <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
              <ul className="space-y-2.5 mb-8 flex-1">
                {["Twitter account audit & strategy","Content calendar creation","8–12 posts per month","Basic Reels & Stories production","Hashtag research & optimisation","Community management","Monthly performance report","Email support"].map(f => (
                  <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
                    <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: TW }} />{f}
                  </li>
                ))}
              </ul>
            ...
            <div className="relative rounded-2xl bg-white flex flex-col"
              ...
              <div className="p-8 flex flex-col">
                ...
                <p className="text-slate-400 text-sm mb-6">Full Twitter management + paid ads<br />and Reels growth campaigns</p>
                <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
                <ul className="space-y-2.5 mb-8 flex-1">
                  {["Everything in Starter, plus","16–20 posts per month","Advanced Reels & Stories production","Twitter Shopping setup","Twitter Ads management","Influencer outreach & management","A/B testing & optimisation","Competitor monitoring","Bi-weekly reporting with insights","Priority support"].map(f => (
                    <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 flex flex-col"
              ...
              <p className="text-slate-400 text-sm mb-6">Full Twitter ecosystem management<br />with dedicated team & strategy</p>
              <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
              <ul className="space-y-2.5 mb-8 flex-1">
                {["Tailored to Your Brand Goals","Full Twitter strategy & roadmap","30+ posts per month","Professional video production & editing","Advanced influencer partnerships","Twitter Shop management & optimisation","Crisis management & brand monitoring","Dedicated Twitter account manager","Weekly performance reviews","Ongoing strategy refinement"].map(f => (
                  <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
          ...
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              ...
              <p className="text-green-100 text-sm leading-relaxed mb-7 max-w-md">
                We help brands build scalable Twitter marketing systems backed by data and
              ...
              <div>
                <Link href="/contact"
                  ...
                  Request an Twitter Strategy Session <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            <div className="md:w-[36%] flex-shrink-0 relative min-h-[200px] hidden md:block">
              <img src="/faq-woman.png" alt="Twitter marketing specialist"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <span className="text-xs font-black tracking-widest uppercase mb-3 block" style={{ color: TW }}>Our Process</span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              How We Deliver{" "}
              <span style={{ color: TW }}>Twitter Marketing<br />Results</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our proven 6-step process ensures your Twitter presence grows strategically, delivering measurable
              follower growth, engagement, and revenue results.
            </p>
          </div>
          {(() => {
            const STEPS = [
              { icon: Search,     iconColor: "#EC4899", iconBg: "#FDF2F8", title: "Twitter\nAudit",        desc: "We start with a comprehensive Twitter audit — analysing your current content performance, competitor benchmarks, audience demographics, and hashtag strategy to identify your biggest growth opportunities.", mt: 0   },
              { icon: Layers,     iconColor: "#F97316", iconBg: "#FFF7ED", title: "Strategy\nDevelopment",   desc: "We create a tailored Twitter strategy including content pillars, Reels themes, posting schedules, hashtag clusters, ad roadmaps, and campaign timelines aligned with your specific business goals.",     mt: 60  },
              { icon: Camera,     iconColor: "#38BDF8", iconBg: "#F0F9FF", title: "Content\nProduction",     desc: "Our creative team produces platform-native Twitter content — Reels, carousels, Stories, and static posts — that resonates with your target audience and is engineered to perform within the algorithm.",  mt: 110 },
              { icon: Zap,        iconColor: "#22C55E", iconBg: "#F0FDF4", title: "Campaign\nLaunch",        desc: "We launch your Twitter campaigns with precision timing, highly targeted paid audiences, and optimised ad placements designed to maximise initial reach, engagement, and follower conversion.",            mt: 0   },
              ...
              { icon: TrendingUp, iconColor: "#EC4899", iconBg: "#FDF2F8", title: "Scale\nand Grow",         desc: "After identifying winning Reels formats and ad creatives, we scale successful campaigns, expand your content calendar, and systematically grow your Twitter presence into a primary revenue channel.",       mt: 0   },
            ];
              ...
              <>
                <div className="hidden lg:flex items-start gap-4 mb-2">
                  {STEPS.map(({ icon: Icon, iconColor, iconBg, title, desc, mt }) => (
                    <div key={title}
                      className="flex-1 rounded-2xl border border-slate-200 bg-white p-5 flex flex-col text-center transition-shadow duration-200 hover:shadow-[0_8px_28px_rgba(29,155,240,0.12)]"
                ...
                <div className="hidden lg:block relative w-full" style={{ height: 80 }}>
                  <svg width="100%" height="80" viewBox="0 0 1000 80" preserveAspectRatio="none" className="absolute inset-0">
                    <defs>
                      <linearGradient id="waveGradTW" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <path d="M 83,18 C 150,18 150,42 233,42 C 316,42 316,66 400,66 C 484,66 484,18 567,18 C 650,18 650,42 733,42 C 816,42 840,18 917,18"
                      fill="none" stroke="url(#waveGradTW)" strokeWidth="2.5" strokeLinecap="round" />
                  </svg>
          ...
          <div className="flex justify-center mt-10">
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-sm"
              style={{ background: TW }}>
              Start Your Twitter Marketing Journey <Send className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              ...
              <span style={{ color: ACCENT }}>Twitter Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed">
              Experience unmatched Twitter marketing excellence powered by creative experts, data-driven
              tools, and proven strategies. We transform your Twitter investment into predictable business growth.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              {
                num: "01", icon: TrendingUp, title: "Proven Twitter Growth Results",
                desc: "Our data-driven Twitter strategies have delivered an average engagement increase of over 260% and significant follower growth for clients across diverse industries, with documented case studies and ROI metrics.",
              },
              {
              ...
              },
              {
                ...
                desc: "We leverage AI-powered tools for optimal posting times, content performance prediction, hashtag analysis, and audience sentiment tracking to stay ahead of Twitter's evolving algorithm.",
              },
              {
                num: "04", icon: Briefcase, title: "Industry-Specific Twitter Expertise",
                desc: "Our Twitter specialists bring deep knowledge of industry-specific trends, audience behaviors, and content formats that resonate within your niche, ensuring authentic and effective campaigns.",
              },
              {
                num: "05", icon: Layers, title: "Full-Spectrum Twitter Management",
                desc: "From feed posts and Reels to Stories, Lives, and Twitter Shopping — we manage every aspect of your Twitter presence with a cohesive strategy that maximises each feature's potential.",
              },
              {
                num: "06", icon: ShieldCheck, title: "Dedicated Twitter Partnership",
                desc: "You work with a dedicated Twitter strategist and creative team who become extensions of your brand, delivering proactive recommendations, trend alerts, and strategic growth guidance.",
              },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[220px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              <h2 className="text-xl md:text-2xl font-black text-white leading-tight mb-3">
                Need to Scale Your{" "}
                <span style={{ color: "#FCD34D" }}>Twitter Presence?</span>
              </h2>
              <p className="text-slate-400 text-sm leading-relaxed mb-7 max-w-sm">
                We deliver consistent, high-quality Twitter content at any volume — so you can scale your
              ...
              <div>
                <Link href="/contact"
                  ...
                  Scale Your Twitter Now <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            {/* Right — image */}
            <div className="md:w-[48%] flex-shrink-0 relative min-h-[220px]">
              <img src="/local-seo-team-analytics.png" alt="Twitter marketing team"
        ...
        const CASES = [
          {
            ...
            desc: "Guidance Whiskey is a premium American whiskey brand built around craftsmanship and culture. We strengthened their Twitter presence as a lifestyle-driven premium brand — growing visibility and deepening audience engagement through curated feed content and Reels campaigns.",
            stats: [
          ...
          },
          {
            ...
            desc: "Allostasis is a coaching brand helping athletes improve focus and recovery through breathwork. We focused on education-based Reels and performance-driven Twitter content to dramatically improve reach and discoverability with their target audience.",
            stats: [
          ...
          },
          {
            ...
            company: "AAKI Corp.",
            desc: "AAKI Corp is a Calgary-based engineering company. We boosted their Twitter presence through targeted content strategies and paid social campaigns, driving qualified leads and strengthening brand authority in the engineering sector.",
            stats: [
              { icon: Activity, label: "Engagement", value: "340%", delta: "Increase" },
            ],
            cta: "Get Your Twitter Audit",
          },
        ];
        const perPage = 3;
          ...
          <section className="py-20" style={{ background: "#f8fafc" }}>
            <div className="container mx-auto px-4 md:px-6">
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
                  Real Twitter Results That Redefine<br />Business Success
                </h2>
                <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
                  Explore our portfolio of successful Twitter marketing campaigns that delivered exceptional results for our
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                {visible.map((c) => (
                  <div key={c.company}
                    className="rounded-2xl border border-slate-200 bg-white overflow-hidden flex flex-col transition-shadow duration-200 hover:shadow-[0_8px_28px_rgba(29,155,240,0.12)]"
                    style={{ boxShadow: "0 1px 6px rgba(0,0,0,0.06)" }}>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <Link href="/contact"
                        ...
                        style={{ borderColor: TW, color: TW }}
                        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = TW; (e.currentTarget as HTMLElement).style.color = "white"; }}
                        onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "transparent"; (e.currentTarget as HTMLElement).style.color = TW; }}>
                        {c.cta} →
                      </Link>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              ...
              <span style={{ color: TW }}>Twitter Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed">
              Get answers to the most common questions about our Twitter Marketing services.
            </p>
          </div>
            ...
            <div className="rounded-2xl border border-slate-100 shadow-sm overflow-hidden bg-white">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-slate-500 text-xs leading-relaxed mb-5">
                  Can&apos;t find the answer you&apos;re looking for? Our Twitter marketing experts are ready to help.
                </p>
                <Link href="/contact"
                  ...
                  style={{ background: TW }}>
                  Ask Our Twitter Experts <ArrowRight className="w-3.5 h-3.5" />
                </Link>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-10">
                Let&apos;s{" "}
                <span style={{ color: TW }}>Get Started</span>
              </h2>
              ...
              <form
                ...
                <div>
                  <textarea
                    placeholder="Tell us about your Twitter goals*" value={form.message}
