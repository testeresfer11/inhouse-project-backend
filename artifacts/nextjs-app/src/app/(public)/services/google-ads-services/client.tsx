...
/* ─────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────── */
export function GoogleAdsServicesPageClient() {
    ...
    <div className="bg-gray-950 text-white min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-24">
          ...
          >
            ...
            <h1 className="font-extrabold leading-tight mb-5">
              <span className="block text-4xl md:text-5xl text-white">Google Ads</span>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Why We Are the Best{" "}
              <span style={{ color: BLUE }}>Google Ads Agency</span>
            </h2>
          </div>
          <p className="text-gray-500 text-center max-w-2xl mx-auto mb-12 text-sm leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-gray-500 text-center max-w-2xl mx-auto mb-14 text-sm leading-relaxed">
            Explore our portfolio of successful Google Ads campaigns that delivered exceptional ROAS, reduced acquisition costs, and generated qualified leads for businesses across various industries.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              },
              {
                ...
                body: "A B2B software company needed to scale qualified demo requests through Google Ads. We built a full-funnel Search and Display strategy with custom intent audiences, lead scoring integration, and conversion-optimised landing pages that tripled qualified leads while reducing cost per lead by 41%.",
                metrics: [
              ...
              },
              {
                ...
                body: "A multi-location healthcare provider needed to increase patient bookings through Google Ads while maintaining HIPAA compliance. We created geo-targeted Search campaigns with location extensions and call tracking that drove a 310% increase in appointment requests across all locations.",
                metrics: [
                  { icon: TrendingUp, label: "Conversions", value: "310%", badge: "Increase", color: BLUE },
                ],
                cta: "Get Your Google Ads Audit",
              },
            ].map((cs, i) => (
              <m.div key={i}
