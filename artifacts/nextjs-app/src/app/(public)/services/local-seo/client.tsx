...
const SERVICE_CARDS = [
  ...
  { img: "/local-card-audit.png",           title: "Local SEO Audit",                       desc: "A comprehensive audit of your GBP, citations, on-page signals, Core Web Vitals, and competitor positions — so we know exactly where to focus first." },
  ...
  { img: "/local-card-consulting.png",      title: "Local SEO Consulting",                  desc: "Monthly strategy calls, competitive analysis, and clear performance reporting so you always know what we're doing and the measurable impact it's having." },
];
...
const SERVICES = [
  { icon: MapPin,    color: "#16A34A", bg: "#F0FDF4", title: "Google Business Profile Optimisation", desc: "We fully optimise your GBP listing — photos, categories, services, Q&A, and review responses — so you dominate the local 3-pack." },
  ...
  { icon: BarChart3, color: "#16A34A", bg: "#F0FDF4", title: "Local Link Building",                  desc: "Earn relevant backlinks from local news sites, chambers of commerce, sponsorships, and community partnerships." },
  { icon: Target,    color: "#DC2626", bg: "#FEF2F2", title: "On-Page Local SEO",                    desc: "Optimise title tags, meta descriptions, schema markup, and location pages to reinforce your local relevance signals." },
];

const WHY_ITEMS = [
  { num: "01", icon: Zap,      title: "Fast Local Rankings",        desc: "Our local SEO campaigns typically move businesses into the top 3 map pack within 60–90 days." },
  ...
  { num: "04", icon: Users,    title: "Dedicated Local SEO Team",   desc: "You get a specialist team — not a generalist — who understands the nuances of hyper-local search." },
  ...
  { num: "06", icon: Globe,    title: "Multi-Location Expertise",   desc: "From single storefronts to franchise chains across 50+ locations, we scale local SEO without losing precision." },
];
...
const INDUSTRIES = [
  ...
  { icon: ShoppingBag,    label: "Shopify",      color: "#16A34A", bg: "#16A34A", img: "/industry-shopify.png" },
  ...
  { icon: Monitor,        label: "Enterprise",   color: "#16A34A", bg: "#16A34A", img: "/industry-enterprise.png" },
];

const FAQS = [
  { q: "Q1. What is local SEO and why does my business need it?",              a: "Local SEO is the process of optimising your online presence to attract customers from specific geographic areas. If you serve a local audience, you need local SEO to appear in Google's map pack and local organic results when people nearby search for your services." },
  { q: "Q2. How long does it take to see results from local SEO?",             a: "Most businesses see measurable improvement in map pack rankings and local traffic within 60–90 days. Competitive markets may take 4–6 months for significant movement." },
  { q: "Q3. What's the difference between local SEO and regular SEO?",        a: "Regular SEO targets broader keyword rankings nationally or globally. Local SEO focuses on geo-specific queries, Google Business Profile, local citations, and the map pack — it's designed to drive foot traffic and local calls." },
  { q: "Q4. How important is Google Business Profile for local SEO?",          a: "It's the single most important local ranking factor. A fully optimised GBP with consistent reviews, photos, and posts significantly improves your chances of appearing in the 3-pack." },
  { q: "Q5. Can you help with multiple business locations?",                    a: "Yes — we have extensive experience managing local SEO across multi-location businesses, franchise networks, and service-area businesses with 2 to 500+ locations." },
  { q: "Q6. Do online reviews affect local SEO rankings?",                     a: "Absolutely. Review quantity, velocity, and rating are confirmed local ranking factors. Our review generation strategy helps you build and maintain a strong review profile." },
  ...
  { q: "Q8. Will you optimise my website as part of local SEO?",               a: "Yes — on-page optimisation including location pages, schema markup, meta data, and mobile performance are all part of our local SEO service." },
];
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 pb-28 pt-28">
          ...
          >
            ...
            <p className="text-sm md:text-base leading-relaxed mb-8" style={{ color: "rgba(255,255,255,0.78)" }}>
              ...
              <strong className="text-white">local SEO services company</strong>, we combine data-driven tactics, Google Business Profile mastery, and citation authority to grow your local visibility.
            </p>
            ...
            <m.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} className="inline-block">
              <Link
                ...
                style={{ background: ACCENT, boxShadow: "0 4px 20px rgba(22,163,74,0.45)" }}
              >
                Get Free Local SEO Audit <ArrowRight className="w-4 h-4" />
              </Link>
            </m.div>
          </m.div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-black text-slate-900 leading-tight mb-4">
              Reliable Local Search Engine Optimisation{" "}
              <span style={{ color: ACCENT }}>Services</span>
            </h2>
            <p className="text-slate-500 text-sm leading-relaxed max-w-xl mx-auto">
              Achieving local success involves more than just being present — it focuses on generating tangible outcomes. As a top local SEO services company, we combine data-driven tactics, creative implementation, and industry expertise to deliver tangible business growth.
            </p>
          </m.div>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <img
                  ...
                  alt="Local SEO team reviewing analytics"
                ...
                <div
                  ...
                  style={{ background: ACCENT, boxShadow: "0 4px 16px rgba(22,163,74,0.4)" }}
                >
            ...
            >
              <p className="text-slate-600 text-base leading-relaxed mb-8">
                Local Search Engine Optimisation (Local SEO) is the practice of optimising your online presence to rank higher in geo-targeted search results — especially Google&apos;s local 3-pack. Unlike paid advertising, local SEO builds long-term, sustainable visibility that generates free, high-quality local traffic 24/7.
              </p>
              <p className="text-slate-600 text-base leading-relaxed mb-8">
                Our comprehensive local SEO services cover everything from Google Business Profile optimisation and citation building to on-page location signals and review generation — ensuring your business becomes the go-to authority in your local market. Whether you&apos;re a single location or a growing multi-site franchise, our proven local SEO strategies deliver measurable results.
              </p>
              <m.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} className="inline-block">
                <Link
                  href="#get-started"
                ...
                >
                  Talk to a Local SEO Expert <ArrowRight className="w-4 h-4" />
                </Link>
              </m.div>
            </m.div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-2xl mx-auto">
              As a trusted local SEO agency, Top SEO Services provides comprehensive local search optimisation services designed to improve map pack rankings, increase foot traffic, and maximise conversions. Our tailored services make sure businesses achieve long-term success in their local market.
            </p>
          </m.div>
            ...
            <div className="grid lg:grid-cols-[1fr_1fr] min-h-[200px]">
              ...
              <div className="flex flex-col justify-center px-10 py-10 relative z-10">
                ...
                <p className="text-sm leading-relaxed mb-8 max-w-sm" style={{ color: "rgba(255,255,255,0.65)" }}>
                  Our local SEO experts build organic growth engines that transform your website into a lead-generating machine with sustainable, long-term rankings.
                </p>
                <div>
                  <m.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} className="inline-block">
                    <Link
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-2xl mx-auto">
              Our local search engine optimisation services deliver sustainable map pack rankings, qualified foot traffic, and measurable revenue. Here&apos;s what sets our local SEO agency apart from the competition.
            </p>
          </m.div>
            ...
            {[
              {
                ...
                desc: "Our local SEO specialists conduct deep keyword and competitor research to identify high-value geo-targeted terms that drive qualified traffic and local conversions for your business.",
              },
              {
                num: "02", icon: TrendingUp, color: "#16A34A", bg: "#F0FDF4", hoverBg: "#F0FDF4",
                bar: "#16A34A",
                title: "Sustainable Local Growth",
                desc: "We build long-term local SEO strategies that deliver compounding results over time. Our map pack optimisation creates a permanent local asset that generates free, qualified traffic 24/7.",
              },
              {
              ...
              },
              {
                ...
                desc: "Access detailed local SEO dashboards showing map pack ranking trends, organic traffic by location, review velocity, and call tracking data. Complete visibility with actionable insights every month.",
              },
              {
              ...
              {
                num: "06", icon: Shield,     color: "#16A34A", bg: "#F0FDF4", hoverBg: "#F0FDF4",
                bar: "#16A34A",
                title: "Proven Local Track Record",
                desc: "With 10,000+ keywords ranked on page one and 450%+ average traffic growth, our local SEO team has the experience and expertise to deliver measurable results across every industry and market.",
              },
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xl mx-auto">
              We deliver industry-specific local SEO strategies that understand your market, target audience, and competitive landscape to drive qualified local traffic and sustainable growth.
            </p>
          </m.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              {[
                ...
                { icon: Target,     bg: "#16A34A", label: "Conversions/Mo",      value: conversions,  prefix: "",   suffix: "" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto items-start">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-slate-50 w-fit">
                ...
                <span className="text-xs text-slate-500">On-Page SEO, Technical SEO, Local SEO</span>
              </div>
              {/* Features */}
              <div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="hidden lg:flex items-start gap-4">
            {[
              ...
              {
                step: "04", color: "#10B981", bg: "#ECFDF5", icon: Leaf,
                title: "Content &\nOn-Page",
          ...
          <div className="flex flex-col gap-4 lg:hidden">
            {[
              ...
              { step: "04", color: "#10B981", bg: "#ECFDF5", icon: Leaf,       title: "Content & On-Page",            desc: "Create and optimise high-quality content, implement on-page SEO, and build internal linking structures." },
      ...
      <section className="py-20" style={{ background: "#F0F6FF" }}>
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid lg:grid-cols-[5fr_8fr] gap-6 items-start">
            ...
            >
              {[
                { q: "Q1. What SEO services do you offer?",                                    a: "We offer comprehensive SEO services including technical SEO, on-page optimisation, local SEO, link building, content creation, e-commerce SEO, and AI-powered SEO solutions tailored to your specific business goals and industry." },
                ...
                { q: "Q8. Can you help with local SEO?",                                      a: "Yes, local SEO is one of our core specialisms. We optimise Google Business Profiles, build local citations, manage reviews, and create location-specific content to dominate local search results and map pack rankings." },
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-lg md:text-xl font-black text-white mb-1">Ready to Dominate Local Search?</h3>
                <p className="text-sm" style={{ color: "rgba(255,255,255,0.75)" }}>
                  Get a free local SEO audit and discover how to appear at the top of local search results.
                </p>
              </div>
