...
const FAQS = [
  { q: "What is Instagram Marketing and why does my business need it?",             a: "Instagram Marketing is the strategic use of Instagram's platform — Reels, Stories, Feed posts, Shopping, and Ads — to grow brand awareness, build communities, drive website traffic, and generate sales. With over 2 billion monthly active users, Instagram is one of the highest-intent discovery platforms available. We build tailored Instagram strategies that put your brand in front of the right audience and convert followers into paying customers." },
  { q: "How long does it take to see results from Instagram Marketing?",            a: "Paid Instagram campaigns can generate clicks and conversions within 48–72 hours of launch. Organic growth — building followers, improving reach, and growing engagement — typically takes 3–6 months to gain real momentum. We set clear, measurable KPIs upfront so you have a transparent roadmap of what to expect and when." },
  { q: "What types of content do you create for Instagram?",                        a: "We produce everything your Instagram presence needs: Reels, Stories sequences, carousels, static feed posts, IGTV videos, UGC-style ads, Highlight covers, and Shoppable posts. Every piece of content is crafted to match your brand identity and engineered to perform within Instagram's algorithm." },
  { q: "How do you grow Instagram followers that are actually my customers?",       a: "Vanity metrics don't build businesses. Our audience growth strategies use targeted hashtag research, collaborative content, engagement pods, paid audience amplification, and lookalike targeting to attract followers who match your actual buyer persona — not just generic accounts boosting a number." },
  { q: "Can Instagram Marketing drive real sales and revenue?",                     a: "Absolutely. We set up and manage Instagram Shopping catalogues, run conversion-optimised Instagram Ads, and build retargeting funnels that follow warm audiences through to purchase. Our clients consistently generate direct product sales, lead form submissions, and DM inquiries through Instagram." },
  { q: "What is the difference between organic Instagram marketing and paid ads?",  a: "Organic Instagram builds your presence through regular posting, Stories, Reels, and community engagement — earning reach naturally over time. Paid Instagram Ads reach specific audiences who have never heard of your brand. The most effective Instagram strategy combines both: organic content builds trust and authority while paid amplification accelerates growth and targets new buyers." },
  { q: "How do you measure the success of Instagram campaigns?",                   a: "We track reach, impressions, profile visits, follower growth, engagement rate (likes, comments, saves, shares), Stories completion rate, Reels views, link-in-bio clicks, Instagram Shop conversions, and ad ROAS. Monthly reports translate every metric into plain business language — what changed, why, and what we're optimising next." },
  { q: "Do I need a large budget for Instagram Marketing?",                         a: "No. We work with a wide range of budgets, from small businesses investing a few hundred pounds per month to enterprises scaling significant paid social budgets. We focus your spend on the highest-converting audiences first, prove performance, then scale systematically once results are validated." },
  { q: "How important are Instagram Reels for my brand?",                           a: "Reels are currently the highest-reach format on Instagram, consistently outperforming all other content types in organic reach. Instagram's algorithm actively pushes Reels to non-followers, making them the single most powerful tool for audience growth in 2025. Our creative team produces trend-native, brand-aligned Reels that maximise both reach and engagement." },
  { q: "Can you manage Instagram alongside other social platforms?",                a: "Yes. We manage multi-platform strategies simultaneously, ensuring Instagram receives content tailored to its specific formats, audience behaviour, and algorithm. Instagram is a visual-first platform that requires a different content approach to LinkedIn, TikTok, or Facebook — and we produce platform-native content for every channel without diluting quality." },
  { q: "What industries do you serve with Instagram Marketing?",                    a: "We work across e-commerce, fashion, beauty, lifestyle, health & wellness, real estate, hospitality, education, professional services, SaaS, and consumer brands. Instagram particularly excels for visual-first industries, though our B2B Instagram strategies consistently deliver results for professional services and technology brands too." },
  { q: "How do I get started with your Instagram Marketing services?",              a: "Getting started is simple. Book a free Instagram strategy call — we audit your current account, review your competitors, and present a tailored Instagram growth plan within 5 business days. No long-term contract on discovery. You only commit once you're confident the strategy is right for your brand." },
];
...
/* ─────────────────────────────────────────────
   PAGE
───────────────────────────────────────────── */
export function InstagramMarketingPageClient() {
    ...
    <div className="font-sans antialiased overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pb-28" style={{ background: "#0B0F1A" }}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img src="/cta-meeting-analytics.png" alt="Instagram Marketing background" className="w-full h-full object-cover opacity-20" />
          ...
          <div className="absolute rounded-full blur-3xl" style={{ width: 320, height: 320, background: "rgba(225,48,108,0.22)", top: "12%", right: "35%" }} />
        ...
        <div className="relative w-full container mx-auto px-6 md:px-12 pt-28">
          ...
          <nav className="flex items-center gap-1.5 text-xs text-slate-400 mb-10">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-slate-300">Instagram Marketing</span>
          </nav>
          ...
          <div className="grid md:grid-cols-[55%_45%] gap-10 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-7 text-xs font-bold tracking-widest uppercase"
                style={{ background: "rgba(225,48,108,0.18)", border: "1px solid rgba(225,48,108,0.4)", color: "#F9A8D4" }}>
                <Instagram className="w-3.5 h-3.5" style={{ color: IG }} />
              ...
              <p className="text-slate-300 text-sm leading-relaxed mb-10 max-w-xl">
                Have you ever thought about why famous influencers&apos; Instagram posts receive millions of likes,
                comments, and shares? Well, we know the cheat code: strategic{" "}
                <strong className="text-white">Instagram marketing services</strong>{" "}
            ...
            <div className="hidden md:flex justify-center items-center">
              <div className="relative" style={{ width: 260 }}>
                ...
                <div className="relative rounded-[44px] overflow-hidden shadow-2xl"
                  ...
                  <div style={{ height: 500, background: "#fafafa" }}>
                    ...
                    <div className="flex items-center justify-between px-4 pt-8 pb-2" style={{ background: "white" }}>
                      <span className="font-black text-sm text-slate-900" style={{ fontFamily: "serif" }}>Instagram</span>
                      <div className="flex gap-3 items-center">
                        <div className="w-5 h-5 rounded-full" style={{ background: "linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)" }} />
                    ...
                    <div className="flex gap-2.5 px-3 py-2 overflow-hidden" style={{ background: "white" }}>
                      {[IG, "#F97316", "#8B5CF6", "#16A34A"].map((c, i) => (
                ...
                <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 rounded-full blur-2xl opacity-40"
                  style={{ width: 200, height: 40, background: IG }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="pt-28 pb-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 text-center leading-tight mb-14">
            What Is Instagram Marketing and<br />
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative h-[400px] select-none">
              ...
              <div className="absolute top-0 left-0 w-[55%] h-[85%] rounded-2xl overflow-hidden shadow-lg">
                <img src="/ai-seo-team.png" alt="Instagram marketing on mobile"
              ...
              <div className="absolute bottom-0 right-0 w-[54%] h-[72%] rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                <img src="/cta-meeting-analytics.png" alt="Instagram social media icons"
                  className="w-full h-full object-cover" />
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-full px-4 py-2 text-white whitespace-nowrap"
                  style={{ background: "linear-gradient(135deg, #E1306C, #F97316)", boxShadow: "0 4px 16px rgba(225,48,108,0.45)" }}>
                  <BarChart3 className="w-3.5 h-3.5 flex-shrink-0" />
                  <div>
                    <p className="text-xs font-extrabold leading-none">5.2× More Engagement</p>
                    <p className="text-[10px] opacity-85 leading-tight mt-0.5">Average Instagram performance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-5 left-0 flex items-center gap-2.5 bg-white rounded-xl px-4 py-3 z-10"
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 mt-0.5">Across client Instagram accounts</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4">
              <p className="text-slate-600 leading-relaxed mb-5">
                Instagram Marketing refers to the process of using the IG platform to create brand recognition
              ...
              <p className="text-slate-600 leading-relaxed mb-8">
                Instagram&apos;s visual appeal and wide audience make it an essential tool for marketers looking to
                tap into consumer desires and connect with potential clients. So, boost your Instagram marketing
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Instagram Features We Master to Grow Your Brand
              <br />
              <span style={{ color: ACCENT }}>and Engage Your Audience</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Top SEO Services delivers comprehensive Instagram marketing services designed to grow your audience,
            ...
            {[
              {
                ...
                desc: "Reels are Instagram's highest-reach format. Our creative team produces trend-native, brand-aligned Reels that maximise organic reach and attract new followers at scale.",
              },
              {
              ...
              {
                name: "Instagram Shopping & E-commerce",
                img: "/industry-shopify.png",
                desc: "We set up and optimise your Instagram Shop catalogue, tag products across Feed, Reels, and Stories, and build a seamless in-app purchase experience that shortens the path to checkout.",
              },
              {
              ...
              },
              {
                ...
                img: "/ai-seo-team.png",
                desc: "We identify, vet, and manage Instagram creator partnerships — from nano-influencers with niche, engaged audiences to macro influencers for mass brand awareness.",
              },
              {
              ...
              },
              {
                ...
                desc: "From prospecting campaigns to retargeting funnels, we manage your Instagram Ad spend with precision — building creative that converts with measurable ROI.",
              },
              {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="md:w-[46%] flex-shrink-0 relative min-h-[220px]">
              <img src="/local-cta-analytics.png" alt="Instagram growth analytics"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-14 py-12 relative z-10">
              <h2 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3">
                Ready to Build an Instagram Presence{" "}
                <span style={{ color: IG }}>That Drives Revenue?</span>
              </h2>
              <p className="text-slate-300 text-sm leading-relaxed mb-8 max-w-md">
                Our Instagram specialists craft strategies tailored to your brand, audience, and growth goals —
              ...
              <div>
                <Link href="/contact"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white text-sm"
                  style={{ background: IG }}>
                  Book a Free Instagram Audit <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              In this competitive world, Instagram marketing performance is vital for businesses looking to broaden their
              reach, engage their audience, and boost conversions. With our results-focused Instagram marketing services
          ...
          {(() => {
            const cards = [
              { num: "01", icon: Target,      color: ACCENT,    title: "Brand Awareness",       desc: "Utilize Instagram's massive reach to grow your brand's presence and recognition." },
              ...
              { num: "05", icon: Users,       color: ACCENT,    title: "Sales & Leads",         desc: "The lead development process enables businesses to convert Instagram followers into customers through direct sales opportunities." },
            ];
            return (
              <>
                {/* Row 1 — 3 cards */}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <span className="text-xs font-bold tracking-widest uppercase mb-3 block" style={{ color: IG }}>
              Industries
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Industries We Support With{" "}
              <span style={{ color: IG }}>Instagram<br />Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Instagram marketing agency delivers industry-scaled services that boost follower growth, content reach,
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { img: "/industry-healthcare.png",  icon: Heart,        iconBg: IG,        label: "Healthcare"  },
          ...
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              ...
              <p className="text-pink-100 text-sm leading-relaxed mb-7 max-w-md">
                We help brands turn Instagram followers into engaged communities and loyal
              ...
              <div>
                <Link href="/contact"
                  ...
                  Schedule Your Instagram Strategy Call <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            <div className="md:w-[36%] flex-shrink-0 relative min-h-[200px] hidden md:block">
              <img src="/ai-seo-team.png" alt="Instagram marketing expert"
                className="absolute bottom-0 right-0 h-full w-full object-cover object-top opacity-90" />
              <div className="absolute inset-0"
                style={{ background: "linear-gradient(to right, " + IG + " 0%, transparent 40%)" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              How Instagram Marketing Services Help
              <br />
              <span style={{ color: ACCENT }}>Modern Businesses to Grow</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Instagram marketing strategies combine creative storytelling, data analytics, and platform expertise to
            ...
            {[
              {
                ...
                desc: "We analyze your ideal Instagram audience — their demographics, interests, behaviors, and peak activity times — to create content strategies that resonate and drive meaningful engagement.",
              },
              {
                icon: Video,
                color: "#DC2626",
                title: "Reels & Video Strategy",
                desc: "Our video team creates scroll-stopping Instagram Reels and video content using trending formats, audio, and hooks that maximize organic reach and virality on the platform.",
              },
              {
                icon: Layers,
                color: "#D97706",
                title: "Visual Content Design",
                desc: "Our designers craft stunning feed posts, carousel slides, and story templates that maintain brand consistency while standing out in crowded Instagram feeds.",
              },
              {
                icon: BarChart3,
                color: "#16A34A",
              ...
              },
              {
                ...
                desc: "Our team actively manages your Instagram community through timely responses, comment engagement, DM management, and proactive outreach that builds loyal brand advocates.",
              },
              {
                icon: RefreshCw,
                color: "#DC2626",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <span className="inline-block text-xs font-bold px-5 py-2 rounded-full border mb-5"
              style={{ borderColor: IG, color: IG }}>
              Pricing
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              Instagram Marketing Packages That Turn
              <br />Followers Into{" "}
              <span style={{ color: IG }}>Customers</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our Instagram marketing packages focus on building engaged audiences, driving Reels reach,
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 flex flex-col"
              ...
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: IG }}>
              ...
              <p className="text-slate-400 text-sm mb-6">Instagram account management<br />— Feed posts, Stories & basic Reels</p>
              <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
              <ul className="space-y-2.5 mb-8 flex-1">
                {["Instagram account audit & strategy","Content calendar creation","8–12 posts per month","Basic Reels & Stories production","Hashtag research & optimisation","Community management","Monthly performance report","Email support"].map(f => (
                  <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
                    <CheckCircle2 className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: IG }} />{f}
                  </li>
                ))}
              </ul>
            ...
            <div className="relative rounded-2xl bg-white flex flex-col"
              ...
              <div className="p-8 flex flex-col">
                ...
                <p className="text-slate-400 text-sm mb-6">Full Instagram management + paid ads<br />and Reels growth campaigns</p>
                <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
                <ul className="space-y-2.5 mb-8 flex-1">
                  {["Everything in Starter, plus","16–20 posts per month","Advanced Reels & Stories production","Instagram Shopping setup","Instagram Ads management","Influencer outreach & management","A/B testing & optimisation","Competitor monitoring","Bi-weekly reporting with insights","Priority support"].map(f => (
                    <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 flex flex-col"
              ...
              <p className="text-slate-400 text-sm mb-6">Full Instagram ecosystem management<br />with dedicated team & strategy</p>
              <p className="text-[10px] font-black tracking-widest text-slate-400 uppercase mb-3">What&apos;s Included:</p>
              <ul className="space-y-2.5 mb-8 flex-1">
                {["Tailored to Your Brand Goals","Full Instagram strategy & roadmap","30+ posts per month","Professional video production & editing","Advanced influencer partnerships","Instagram Shop management & optimisation","Crisis management & brand monitoring","Dedicated Instagram account manager","Weekly performance reviews","Ongoing strategy refinement"].map(f => (
                  <li key={f} className="flex items-start gap-2.5 text-slate-600 text-sm">
          ...
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[200px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              ...
              <p className="text-green-100 text-sm leading-relaxed mb-7 max-w-md">
                We help brands build scalable Instagram marketing systems backed by data and
              ...
              <div>
                <Link href="/contact"
                  ...
                  Request an Instagram Strategy Session <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            <div className="md:w-[36%] flex-shrink-0 relative min-h-[200px] hidden md:block">
              <img src="/faq-woman.png" alt="Instagram marketing specialist"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <span className="text-xs font-black tracking-widest uppercase mb-3 block" style={{ color: IG }}>Our Process</span>
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              How We Deliver{" "}
              <span style={{ color: IG }}>Instagram Marketing<br />Results</span>
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
              Our proven 6-step process ensures your Instagram presence grows strategically, delivering measurable
              follower growth, engagement, and revenue results.
            </p>
          </div>
          {(() => {
            const STEPS = [
              { icon: Search,     iconColor: "#EC4899", iconBg: "#FDF2F8", title: "Instagram\nAudit",        desc: "We start with a comprehensive Instagram audit — analysing your current content performance, competitor benchmarks, audience demographics, and hashtag strategy to identify your biggest growth opportunities.", mt: 0   },
              { icon: Layers,     iconColor: "#F97316", iconBg: "#FFF7ED", title: "Strategy\nDevelopment",   desc: "We create a tailored Instagram strategy including content pillars, Reels themes, posting schedules, hashtag clusters, ad roadmaps, and campaign timelines aligned with your specific business goals.",     mt: 60  },
              { icon: Camera,     iconColor: "#38BDF8", iconBg: "#F0F9FF", title: "Content\nProduction",     desc: "Our creative team produces platform-native Instagram content — Reels, carousels, Stories, and static posts — that resonates with your target audience and is engineered to perform within the algorithm.",  mt: 110 },
              { icon: Zap,        iconColor: "#22C55E", iconBg: "#F0FDF4", title: "Campaign\nLaunch",        desc: "We launch your Instagram campaigns with precision timing, highly targeted paid audiences, and optimised ad placements designed to maximise initial reach, engagement, and follower conversion.",            mt: 0   },
              ...
              { icon: TrendingUp, iconColor: "#EC4899", iconBg: "#FDF2F8", title: "Scale\nand Grow",         desc: "After identifying winning Reels formats and ad creatives, we scale successful campaigns, expand your content calendar, and systematically grow your Instagram presence into a primary revenue channel.",       mt: 0   },
            ];
              ...
              <>
                <div className="hidden lg:flex items-start gap-4 mb-2">
                  {STEPS.map(({ icon: Icon, iconColor, iconBg, title, desc, mt }) => (
                    <div key={title}
                      className="flex-1 rounded-2xl border border-slate-200 bg-white p-5 flex flex-col text-center transition-shadow duration-200 hover:shadow-[0_8px_28px_rgba(225,48,108,0.12)]"
                ...
                <div className="hidden lg:block relative w-full" style={{ height: 80 }}>
                  <svg width="100%" height="80" viewBox="0 0 1000 80" preserveAspectRatio="none" className="absolute inset-0">
                    <defs>
                      <linearGradient id="waveGradIG2" x1="0%" y1="0%" x2="100%" y2="0%">
                    ...
                    <path d="M 83,18 C 150,18 150,42 233,42 C 316,42 316,66 400,66 C 484,66 484,18 567,18 C 650,18 650,42 733,42 C 816,42 840,18 917,18"
                      fill="none" stroke="url(#waveGradIG2)" strokeWidth="2.5" strokeLinecap="round" />
                  </svg>
          ...
          <div className="flex justify-center mt-10">
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-sm"
              style={{ background: IG }}>
              Start Your Instagram Marketing Journey <Send className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              ...
              <span style={{ color: ACCENT }}>Instagram Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed">
              Experience unmatched Instagram marketing excellence powered by creative experts, data-driven
              tools, and proven strategies. We transform your Instagram investment into predictable business growth.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              {
                num: "01", icon: TrendingUp, title: "Proven Instagram Growth Results",
                desc: "Our data-driven Instagram strategies have delivered an average engagement increase of over 260% and significant follower growth for clients across diverse industries, with documented case studies and ROI metrics.",
              },
              {
              ...
              },
              {
                ...
                desc: "We leverage AI-powered tools for optimal posting times, content performance prediction, hashtag analysis, and audience sentiment tracking to stay ahead of Instagram's evolving algorithm.",
              },
              {
                num: "04", icon: Briefcase, title: "Industry-Specific Instagram Expertise",
                desc: "Our Instagram specialists bring deep knowledge of industry-specific trends, audience behaviors, and content formats that resonate within your niche, ensuring authentic and effective campaigns.",
              },
              {
                num: "05", icon: Layers, title: "Full-Spectrum Instagram Management",
                desc: "From feed posts and Reels to Stories, Lives, and Instagram Shopping — we manage every aspect of your Instagram presence with a cohesive strategy that maximises each feature's potential.",
              },
              {
                num: "06", icon: ShieldCheck, title: "Dedicated Instagram Partnership",
                desc: "You work with a dedicated Instagram strategist and creative team who become extensions of your brand, delivering proactive recommendations, trend alerts, and strategic growth guidance.",
              },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch min-h-[220px]"
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-12 py-10 relative z-10">
              <h2 className="text-xl md:text-2xl font-black text-white leading-tight mb-3">
                Need to Scale Your{" "}
                <span style={{ color: "#FCD34D" }}>Instagram Presence?</span>
              </h2>
              <p className="text-slate-400 text-sm leading-relaxed mb-7 max-w-sm">
                We deliver consistent, high-quality Instagram content at any volume — so you can scale your
              ...
              <div>
                <Link href="/contact"
                  ...
                  Scale Your Instagram Now <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            {/* Right — image */}
            <div className="md:w-[48%] flex-shrink-0 relative min-h-[220px]">
              <img src="/local-seo-team-analytics.png" alt="Instagram marketing team"
        ...
        const CASES = [
          {
            ...
            desc: "Guidance Whiskey is a premium American whiskey brand built around craftsmanship and culture. We strengthened their Instagram presence as a lifestyle-driven premium brand — growing visibility and deepening audience engagement through curated feed content and Reels campaigns.",
            stats: [
          ...
          },
          {
            ...
            desc: "Allostasis is a coaching brand helping athletes improve focus and recovery through breathwork. We focused on education-based Reels and performance-driven Instagram content to dramatically improve reach and discoverability with their target audience.",
            stats: [
          ...
          },
          {
            ...
            company: "AAKI Corp.",
            desc: "AAKI Corp is a Calgary-based engineering company. We boosted their Instagram presence through targeted content strategies and paid social campaigns, driving qualified leads and strengthening brand authority in the engineering sector.",
            stats: [
              { icon: Activity, label: "Engagement", value: "340%", delta: "Increase" },
            ],
            cta: "Get Your Instagram Audit",
          },
        ];
        const perPage = 3;
          ...
          <section className="py-20" style={{ background: "#f8fafc" }}>
            <div className="container mx-auto px-4 md:px-6">
              <div className="text-center mb-14">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
                  Real Instagram Results That Redefine<br />Business Success
                </h2>
                <p className="text-slate-500 max-w-2xl mx-auto text-sm leading-relaxed">
                  Explore our portfolio of successful Instagram marketing campaigns that delivered exceptional results for our
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                {visible.map((c) => (
                  <div key={c.company}
                    className="rounded-2xl border border-slate-200 bg-white overflow-hidden flex flex-col transition-shadow duration-200 hover:shadow-[0_8px_28px_rgba(225,48,108,0.12)]"
                    style={{ boxShadow: "0 1px 6px rgba(0,0,0,0.06)" }}>
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      ...
                      <Link href="/contact"
                        ...
                        style={{ borderColor: IG, color: IG }}
                        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = IG; (e.currentTarget as HTMLElement).style.color = "white"; }}
                        onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "transparent"; (e.currentTarget as HTMLElement).style.color = IG; }}>
                        {c.cta} →
                      </Link>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-4">
              ...
              <span style={{ color: IG }}>Instagram Marketing</span>
            </h2>
            <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed">
              Get answers to the most common questions about our Instagram Marketing services.
            </p>
          </div>
            ...
            <div className="rounded-2xl border border-slate-100 shadow-sm overflow-hidden bg-white">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-slate-500 text-xs leading-relaxed mb-5">
                  Can&apos;t find the answer you&apos;re looking for? Our Instagram marketing experts are ready to help.
                </p>
                <Link href="/contact"
                  ...
                  style={{ background: IG }}>
                  Ask Our Instagram Experts <ArrowRight className="w-3.5 h-3.5" />
                </Link>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight mb-10">
                Let&apos;s{" "}
                <span style={{ color: IG }}>Get Started</span>
              </h2>
              ...
              <form
                ...
                <div>
                  <textarea
                    placeholder="Tell us about your Instagram goals*" value={form.message}
