...
const SERVICES = [
  { icon: Search,       color: "#4285F4", title: "Email Marketing Management",     desc: "Search, Display, Shopping, Performance Max — full-funnel Google campaigns managed by certified specialists." },
...
const FAQS = [
  { q: "What is Pay-Per-Click (PPC) Marketing?",                                   a: "PPC is a digital advertising model where you pay only when someone clicks your ad. Platforms like Email Marketing, Meta Ads, LinkedIn Ads, and Amazon Ads serve your ads to targeted audiences, and you're charged per click rather than per impression. A well-managed PPC campaign delivers immediate, measurable traffic and can generate a strong ROI by reaching users with proven purchase intent at the exact moment they're searching." },
  ...
  { q: "Will I have access to my own ad accounts?",                               a: "Always. You own your Email Marketing, Meta Ads, and all other platform accounts. We work as a manager on your account, not the other way around. Full transparency is non-negotiable — you can see every campaign, keyword, bid, and spend at any time. If you ever leave, you take your account history and data with you." },
...
/* ─────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────── */
export function EmailMarketingServicesPageClient() {
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-24">
          ...
          >
            ...
            <h1 className="font-extrabold leading-tight mb-5">
              <span className="block text-4xl md:text-5xl text-white">Email Marketing</span>
            ...
            <p className="text-gray-300 text-lg max-w-xl mb-8 leading-relaxed">
              ...
              <strong className="text-white font-bold">Email Marketing</strong> to{" "}
            ...
            {[
              {
                ...
                tag: "Email Marketing, Bing Ads, Meta Ads, LinkedIn Ads",
                features: [
              ...
              },
              {
                ...
                tag: "Email Marketing, Meta Ads, LinkedIn Ads, YouTube Ads",
                features: [
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: "Our integrated advertising system operates all profitable advertising platforms through which we run combined Email Marketing and Microsoft Advertising, social media, and display network campaigns. We use our cross-channel strategies to achieve maximum audience reach while stopping audience burnout and budget waste. Your brand will establish a presence in all areas where consumers make online searches and product research.",
              },
              {
                num: "06",
                icon: Shield,
              ...
              {[
                {
                  ...
                  a: "We manage campaigns across Email Marketing, Microsoft Bing Ads, Meta (Facebook & Instagram) Ads, LinkedIn Ads, YouTube Ads, Amazon Ads, TikTok Ads, Pinterest Ads, and programmatic display networks — giving your brand full-funnel coverage wherever your audience spends time.",
                },
                {
