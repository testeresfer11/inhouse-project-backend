...
const SERVICES = [
  { icon: Search,       color: "#4285F4", title: "LinkedIn Ads Management",     desc: "Search, Display, Shopping, Performance Max — full-funnel Google campaigns managed by certified specialists." },
...
const FAQS = [
  { q: "What is Pay-Per-Click (PPC) Marketing?",                                   a: "PPC is a digital advertising model where you pay only when someone clicks your ad. Platforms like LinkedIn Ads, Meta Ads, LinkedIn Ads, and Amazon Ads serve your ads to targeted audiences, and you're charged per click rather than per impression. A well-managed PPC campaign delivers immediate, measurable traffic and can generate a strong ROI by reaching users with proven purchase intent at the exact moment they're searching." },
  ...
  { q: "Will I have access to my own ad accounts?",                               a: "Always. You own your LinkedIn Ads, Meta Ads, and all other platform accounts. We work as a manager on your account, not the other way around. Full transparency is non-negotiable — you can see every campaign, keyword, bid, and spend at any time. If you ever leave, you take your account history and data with you." },
...
/* ─────────────────────────────────────────────
   COMPONENT
───────────────────────────────────────────── */
export function LinkedInAdsServicesPageClient() {
    ...
    <div className="bg-gray-950 text-white min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-24">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-7 text-xs font-bold tracking-widest uppercase"
              ...
              #1 LinkedIn Ads Agency
            </div>

            {/* Heading */}
            <h1 className="font-extrabold leading-tight mb-5">
              <span className="block text-4xl md:text-5xl text-white">LinkedIn Ads</span>
            ...
            <p className="text-gray-300 text-lg max-w-xl mb-8 leading-relaxed">
              ...
              <strong className="text-white font-bold">LinkedIn Ads</strong> to{" "}
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-4">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
              Types of LinkedIn Ads Campaign
            </h2>
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: BLUE }}>
              Management Services
            </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: "#16A34A" }}>
              LinkedIn Ads Services Packages
            </h2>
          </div>
          <p className="text-gray-500 text-center max-w-2xl mx-auto mb-14 text-sm leading-relaxed">
            ...
            {[
              {
                ...
                tag: "LinkedIn Ads, Bing Ads, Meta Ads, LinkedIn Ads",
                features: [
              ...
              },
              {
                ...
                tag: "LinkedIn Ads, Meta Ads, LinkedIn Ads, YouTube Ads",
                features: [
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                body: "Our integrated advertising system operates all profitable advertising platforms through which we run combined LinkedIn Ads and Microsoft Advertising, social media, and display network campaigns. We use our cross-channel strategies to achieve maximum audience reach while stopping audience burnout and budget waste. Your brand will establish a presence in all areas where consumers make online searches and product research.",
              },
              {
                num: "06",
                icon: Shield,
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight">
              Why We Are the Best{" "}
              <span style={{ color: BLUE }}>LinkedIn Ads Agency</span>
            </h2>
          </div>
          <p className="text-gray-500 text-center max-w-2xl mx-auto mb-12 text-sm leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="text-center mb-4">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
              Real LinkedIn Ads Results That
            </h2>
            <h2 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: BLUE }}>
          ...
          <p className="text-gray-500 text-center max-w-2xl mx-auto mb-14 text-sm leading-relaxed">
            Explore our portfolio of successful LinkedIn Ads campaigns that delivered exceptional ROAS, reduced acquisition costs, and generated qualified leads for businesses across various industries.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              },
              {
                ...
                body: "A B2B software company needed to scale qualified demo requests through LinkedIn Ads. We built a full-funnel Search and Display strategy with custom intent audiences, lead scoring integration, and conversion-optimised landing pages that tripled qualified leads while reducing cost per lead by 41%.",
                metrics: [
              ...
              },
              {
                ...
                body: "A multi-location healthcare provider needed to increase patient bookings through LinkedIn Ads while maintaining HIPAA compliance. We created geo-targeted Search campaigns with location extensions and call tracking that drove a 310% increase in appointment requests across all locations.",
                metrics: [
                  { icon: TrendingUp, label: "Conversions", value: "310%", badge: "Increase", color: BLUE },
                ],
                cta: "Get Your LinkedIn Ads Audit",
              },
            ].map((cs, i) => (
              <m.div key={i}
              ...
              {[
                {
                  ...
                  a: "We manage campaigns across LinkedIn Ads, Microsoft Bing Ads, Meta (Facebook & Instagram) Ads, LinkedIn Ads, YouTube Ads, Amazon Ads, TikTok Ads, Pinterest Ads, and programmatic display networks — giving your brand full-funnel coverage wherever your audience spends time.",
                },
                {
